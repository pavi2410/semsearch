...
_STOP_WORDS: set[str] = {
    ...
    "can", "will", "just", "should", "now", "its", "it", "i", "we", "you",
    "he", "she", "they", "me", "him", "her", "us", "them", "my", "your",
    "his", "their", "our", "do", "did", "does", "doing", "done", "has",
    "have", "had", "having", "be", "been", "being", "was", "were", "am",
    "are", "is", "been", "being", "get", "got", "getting", "gets",
    "would", "could", "shall", "may", "might", "must", "need", "dare",
    "used", "ought", "please", "help", "every", "each", "ever", "never",
}
